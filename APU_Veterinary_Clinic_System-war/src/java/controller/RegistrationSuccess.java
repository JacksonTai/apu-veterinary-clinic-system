 ...
 * @author Jackson Tai
 */
@WebServlet(name = "RegistrationSuccess", urlPatterns = {REGISTRATION_SUCCESS})
public class RegistrationSuccess extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("shared/page" + REGISTRATION_SUCCESS + ".jsp").forward(request, response);
    }
