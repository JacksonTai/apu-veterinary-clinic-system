...
public class En {
    ...
    public static final String INVALID_STAFF_EMAIL_MESSAGE = "Email is invalid.";
    ...
    public static final String UNMATCHED_NEW_PASSWORD_MESSAGE = "New passwords do not match";
    ...
    public static final String INVALID_LENGTH_FULL_NAME_MESSAGE = "Full Name must be between 8 to 50 characters long.";
