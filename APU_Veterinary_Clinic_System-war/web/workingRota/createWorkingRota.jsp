    ...
    <c:if test="${empty vets}">
        <div class="d-flex flex-column align-items-center justify-content-center">
            <img src="${pageContext.request.contextPath}/asset/img/noRecord.png" alt="No Record Illustration"
                 width="35%">
            <h2 class="text-center">There are no vets to create working rota currently</h2>
        </div>
    </c:if>
    <c:if test="${not empty vets}">
        ...
        <c:if test="${not empty maxWorkingRota and maxWorkingRota eq true}">
            <div class="alert alert-warning mt-4" role="alert">
                There is no week available to create working rota. You can only create working rota for the next 4
                weeks.
            </div>
        </c:if>
