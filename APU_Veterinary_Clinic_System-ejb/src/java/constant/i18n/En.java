...
public class En {
    ...
    public static final String INVALID_FULL_NAME_MESSAGE = "Full name must be between 1 and 50 characters and cannot consists of numbers or more than one white space.";
